...
# from compare_shock_plots import HydroSimData
from rad_hydro_sim.output_paths import get_rad_hydro_npz_path
from rad_hydro_sim.plotting.gif import save_history_gif
from rad_hydro_sim.verification.verification_config import (
    VerificationMode,
    ReferenceSolver,
    get_preset_for_mode,
...
from rad_hydro_sim.problems.presets_config import (
...
def run_radiation_only_comparison(
    ...
    from rad_hydro_sim.verification.run_diffusion_1d import run_diffusion_1d
...
# Deleted radiation_coeff_scheme comparison: legacy scheme removed, only face-weighted remains.
