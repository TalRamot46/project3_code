...
m0=(10^(12*mw(1)))*(10^(-9*(mw(3)-mw(1)*tau)))*xsi*(mat.V0^mw(2)); %g/cm*2
e0=(10^(12*ew(1)))*(10^(-9*(ew(3)-ew(1)*tau)))*z*(mat.V0^ew(2)); %J/cm*2
u0=(10^(12*uw(1)))*(10^(-9*(uw(3)-uw(1)*tau)))*utilda*(mat.V0^uw(2)); %cm/s
end