# run_shock_profiles.py (legacy – pre-MATLAB-exact version)
# Preserved for reference. Do not import; use shock_solver.run_shock_solver instead.
...
def compute_shock_profiles(mat: Material, P0: float, Pw, times=None, *, save_npz: str | None = None,) -> dict:
    """
    Legacy implementation (mixed units / overwrite block). Use shock_solver.run_shock_solver instead.
    """
