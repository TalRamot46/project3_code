...
class SubsonicHeatWave():
    ...
    def set_energy_integrals(self):
        ...
        ekin_integral_simps = scipy.integrate.simps(y=integrand_kin, x=xsi_vec)
        ein_integral_simps = scipy.integrate.simps(y=integrand_in, x=xsi_vec)
        etot_integral_simps = scipy.integrate.simps(y=integrand_tot, x=xsi_vec)
    ...
    def test_V_integral(self):
        ...
        V_integral_total_simps = scipy.integrate.simps(y=V, x=xsi_vec)
